      ...
      link: function link($scope, element, attrs, modelCtrl) {
        ...
        _setDatePoint = function _setDatePoint(setter) {
          return function (newValue) {
            if (_picker && newValue) {
              return setter((0, _moment2.default)(newValue));
            }
          };
        };
        ...
        _validate = function _validate(validator) {
          return function (boundary, actual) {
            if (boundary && actual) {
              return validator((0, _moment2.default)(boundary), (0, _moment2.default)(actual));
            } else {
              return true;
            }
          };
        ...
        modelCtrl.$formatters.push(function (objValue) {
          ...
          f = function f(date) {
            if (!_moment2.default.isMoment(date)) {
              return (0, _moment2.default)(date).format(opts.locale.format);
            } else {
        ...
        modelCtrl.$parsers.push(function (val) {
          var f, objValue, x;
          f = function f(value) {
            return (0, _moment2.default)(value, opts.locale.format);
          };
          objValue = {
            startDate: null,
            endDate: null
        ...
        _initBoundaryField = function _initBoundaryField(field, validator, modelField, optName) {
          if (attrs[field]) {
            ...
            return $scope.$watch(field, function (date) {
              opts[optName] = date ? (0, _moment2.default)(date) : false;
              //手动调一次校验
              modelCtrl.$validate();
              return _init();
            });
